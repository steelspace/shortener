...
namespace UrlShortener.Shortener.Test
{
    public class UrlShortenerShould
    {
        ...
        private readonly Regex _shorUrlSlug = new Regex("[a-z][0-9]");
        ...
        {
            _dataProviderMock.Setup(d => d.AddUrl(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>())).ReturnsAsync(true);
            ...
            Assert.Matches(_shorUrlSlug, shortUrl);
        }
